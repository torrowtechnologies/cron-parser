...
CronExpression.prototype._findSchedule = function _findSchedule (reverse) {
  ...
  while (stepCount < LOOP_LIMIT) {
    ...
    // Add or subtract day if not day of month is set (and no match)
    if (!matchSchedule(currentDate.getDate(), this._fields.dayOfMonth)) {
      this._applyTimezoneShift(currentDate, dateMathVerb, 'Day');
      continue;
    }

    // Add or subtract day if not day of week is set (and no match)
